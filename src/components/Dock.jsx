...
export default function Dock() {
  return (
    <div className="mobile-bar">
      <a href="tel:+390200000000" className="mobile-bar-item">
      ...
      <Link to="/prenotazioni" className="mobile-bar-item mobile-bar-cta">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="22" height="22" aria-hidden="true">
      ...
      <a href="https://wa.me/390000000000" target="_blank" rel="noopener noreferrer" className="mobile-bar-item">
